...
---@param node number The node
---@return fun(): number @Iterator with fields: `child`
---@return table
---@return number
...
---@return fun(): number @Iterator with fields: `node`
---@return table
function Tree:DepthFirstIterator(rootNode)
	...
	return private.DepthFirstIteratorHelper, queue
end
...
---@param rootNode? number The root node to dump from
