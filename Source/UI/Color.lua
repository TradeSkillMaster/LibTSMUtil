...
function Color.__static.NewFromHex(hex)
	return Color(Color.HexToRGBA(hex))
end
...
---@return boolean
function Color.__static.IsValidHexRGB(str)
	str = strlower(str)
	return strmatch(str, "^#[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]$") and true or false
end
...
---@return number b
---@return number a
function Color.__static.HexToRGBA(hex)
	return private.HexToRGBA(hex)
end
...
---@param text string|number The text string to color
---@return string
