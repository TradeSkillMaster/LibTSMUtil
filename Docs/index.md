...
[LibTSMUtil](https://github.com/TradeSkillMaster/LibTSMUtil) provides many general utility
functions and classes that have proven helpful when writing complex WoW addons.
...
* **[Lua](./DebugStack)** contains extensions on the various built-in Lua libraries and data types
* **[BaseType](./ContextManager)** contains general utility classes and data types
* **[Util](./BinarySearch)** contains additional classes and modules which don't fit into other modules
* **[Format](./CSV)** contains modules for formatting and encoding data into a variety of string formats
* **[UI](./Color)** contains some UI-related utility classes and modules
* **[FSM](./FSM)** contains a finite state machine implementation
